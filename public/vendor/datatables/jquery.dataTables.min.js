...
(function (h) {
      ...
      return (
        a.iDrawError != e &&
          ...
          (K(
            a,
            0,
            "Requested unknown parameter " + ("function" == typeof f.mData ? "{function}" : "'" + f.mData + "'") + " for row " + b + ", column " + c,
            4
          ),
          (a.iDrawError = e)),
        j
  ...
  function lb(a) {
    ...
    for (c = l.length; b < c; b++)
      (f = l[b]),
        ...
        i && d.appendTo(e),
        a.oFeatures.bSort &&
          (d.addClass(f.sSortingClass), !1 !== f.bSortable && (d.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), Ma(a, f.nTh, b))),
  ...
  function qb(a) {
    var b = a.oClasses,
      ...
      f = function () {
        ...
        b != e.sSearch &&
          (ga(a, { sSearch: b, bRegex: e.bRegex, bSmart: e.bSmart, bCaseInsensitive: e.bCaseInsensitive }), (a._iDisplayStart = 0), P(a));
      },
  ...
  h.extend(s.prototype, {
    ...
    iterator: function (a, b, c, d) {
      ...
      return e.length || d
        ? ((a = new s(l, a ? e.concat.apply([], e) : e)), (b = a.selector), (b.rows = u.rows), (b.cols = u.cols), (b.opts = u.opts), a)
        : this;
    },
    lastIndexOf:
      w.lastIndexOf ||
  ...
  u("columns().search()", "column().search()", function (a, b, c, d) {
    return this.iterator("column", function (e, f) {
      ...
      e.oFeatures.bFilter &&
        (h.extend(g[f], { sSearch: a + "", bRegex: null === b ? !1 : b, bSmart: null === c ? !0 : c, bCaseInsensitive: null === d ? !0 : d }),
  ...
  n.defaults = {
    ...
    oClasses: {},
    oLanguage: {
      oAria: { sSortAscending: ": ative para ordernar ascendente", sSortDescending: ":  ative para ordernar descendente" },
      oPaginate: { sFirst: "Primeira", sLast: "Ultima", sNext: "Proxima", sPrevious: "Anterior" },
      sEmptyTable: "No data available in table",
      sInfo: "Mostrando de _START_ à _END_ de _TOTAL_ entradas",
